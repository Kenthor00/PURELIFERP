          ...
          <div className="space-y-6">
            ...
            {myStats && (
              <div className="grid grid-cols-4 gap-4">
                ...
                <div className="card-tactical p-4 text-center">
                  <div className="text-2xl font-heading text-green-400">{myStats.total_clicks}</div>
          ...
          <div className="space-y-6">
            ...
            {allStats && (
              <div className="grid grid-cols-3 lg:grid-cols-6 gap-4">
                ...
                <div className="card-tactical p-4 text-center">
                  <div className="text-2xl font-heading text-green-400">{allStats.total_clicks}</div>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className={`flex-1 px-4 py-2 ${
                  actionModal.action === 'approve' ? 'bg-green-600' : 'bg-red-600'
                }`}
              >
                Conferma
              </button>
