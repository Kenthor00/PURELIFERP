...
export const TopBar = () => {
  ...
  const menuItems = [
    ...
    { divider: true },
    { label: 'Weazel News', path: '/city/news', icon: Newspaper, public: true },
    { label: 'Redazione News', path: '/news/editor', icon: Zap, sectors: ['NEWS', 'ADMIN'] },
    { label: 'Service Chat', path: '/chat', icon: MessageSquare },
    { divider: true },
